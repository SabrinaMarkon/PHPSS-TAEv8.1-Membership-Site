...
<table><tr><td>
             ...
             <?
	               ...
	               if ($jvcommission<>0) {                   	 	                                echo "<p>".$jvcommission."% commission for every ".$lowerlevel." member referred";
                                }
                             if ($jvjvcom<>0) {                                                              	                                echo "<p>".$jvjvcom."% commission for every ".$middlelevel." Member referred";
                               }
                            if ($jvsupercom<>0) {                   	 	                                echo "<p>".$jvsupercom."% commission for every ".$toplevel." Member referred";
                              }
               ...
               <?
	               ...
	               if ($superjvreadearn<>0) {
                		...
                		echo "<p>When a referrer purchases advertising you earn ".$superjvbuycom." percent in commissions</p>";
							...
							if ($superjvcommission<>0) {    echo "<p>".$superjvcommission."% commission for every " . $lowerlevel . " member referred";
                                }
                             if ($superjvjvcom<>0) { 
								 echo "<p>".$superjvjvcom."% commission for every " . $middlelevel . " Member referred";
                               }
                            if ($superjv2supercom<>0) {
							echo "<p>".$superjv2supercom." % commission for every " . $toplevel . " Member referred";
                              }
               ...
               <?
	              ...
	              if ($superjvpoints<>0) {
	               ...
	               if ($superjvcommission<>0) {                   	 	                                echo "<p>".$superjvcommission."% commission for every " . $lowerlevel . " member referred";
                             ...
                             if ($superjvjvcom<>0) {                                                              	                                echo "<p>".$superjvjvcom."% commission for every " . $middlelevel . " Member referred";
                               }
                            if ($superjv2supercom<>0) {                   	 	                                echo "<p>".$superjv2supercom."% commission for every " . $toplevel . " Member referred";
                              }
