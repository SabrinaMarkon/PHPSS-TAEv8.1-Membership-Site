...
if($userid != "") {
	...
	if (($_POST[x]) && (substr($_SESSION[igif], 16) === $_SESSION['afloat'])) {
		...
		if ($autosurf === 'yes') {
			$mess = "You clicked the wrong image. Redirecting to next surf url...";
		} else {
		...
		<center>
			<a href="index.php" target="_top">Return to Members Area</a> - <a href="mysurf.php" target="_top">Add Your
				Site</a> - <a href="support.php" target="_blank">Report This Site</a> - <a href="advertisestats.php" target="_top">Set Up Your Ads</a>
...
########
				...
				{
					if ($autosurf === 'yes') {
						echo "<br>Redirecting to next surf url...<br>";
					} else {
				...
				{
					if ($autosurf === 'yes') {
						echo "<br>You have earned $earn surf credits. Redirecting to next surf url...<br>";
					} else {
				...
				if ($_SESSION['currentsurfpage_status'] == 'pending' && $_SESSION['currentsurfpage_id'] != $surf_last_id) {
					...
					echo "You were already credited today for this surf page. Redirecting to next surf url...";
				}
			}
			?>
		</center>
		...
		$aler = "> 78";
		if (round($num1 . "." . $num2) <= round($num3 . "." . $num4)) {
			$aler = "< 105";
		}
		...
		<center>
			...
			<a href="index.php" target="_top">Return to Members Area</a> - <a href="mysurf.php" target="_top">Add Your
				Site</a> - <a href="support.php" target="_blank">Report This Site</a> - <a href="advertisestats.php"
																						   target="_top">Set Up Your
				Ads</a><br>
