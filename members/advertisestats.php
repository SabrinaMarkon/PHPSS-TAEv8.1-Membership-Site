...
if($_POST['action'] = "resetbuttons") {
   ...
   if($_POST['dell']) {
	   $sql = mysql_query("DELETE FROM loginads where userid='".$userid."' and id = '".intval($_POST['dell'])."' LIMIT 1");
   }
   
   
   if($_POST['delt']) {
	   $sql = mysql_query("DELETE FROM tlinks where userid='".$userid."' and id = '".intval($_POST['delt'])."' LIMIT 1");
	   if(@mysql_num_rows($sql)) mysql_query("DELETE FROM tlviews where tlid='".intval($_POST['delt'])."'");
   }
   
 if($_POST['delptc']) {
	   $sql = mysql_query("DELETE FROM ptcads where userid='".$userid."' and id = '".intval($_POST['delptc'])."' LIMIT 1");
	   if(@mysql_num_rows($sql)) mysql_query("DELETE FROM ptcadviews where tlid='".intval($_POST['delt'])."'");
   }
 if($_POST['delfullloginad']) {
	   $sql = mysql_query("DELETE FROM fullloginads where userid='".$userid."' and id = '".intval($_POST['delfullloginad'])."' LIMIT 1");
 ...
 if($_POST['delfeaturedad']) {
  ...
  if($_POST['delhheadlinead']) {
	   ...
	   $sql = mysql_query("DELETE FROM hheadlineads where userid='".$userid."' and id = '".intval($_POST['delhheadlinead'])."' LIMIT 1");
 ...
 if($_POST['delhheaderad']) {
	   ...
	   $sql = mysql_query("DELETE FROM hheaderads where userid='".$userid."' and id = '".intval($_POST['delhheaderad'])."' LIMIT 1");
...
############################################################################## FULL PAGE LOGIN AD STATS - Sabrina Markon May 30 2010
	    $query3 = "select * from fullloginads where userid='".$userid."'";
...
############################################################################## FEATURED AD STATS - Sabrina Markon June 2 2010
	    $query3 = "select * from featuredads where userid='".$userid."'";
	    $result3 = mysql_query ($query3) or die(mysql_error());
	    $numrows3 = @ mysql_num_rows($result3);
	    if ($numrows3 == 0) {
	        ?>
...
############################################################################## HOT HEADLINE ADZ STATS - Sabrina Markon July 11 2010
	    $query3 = "select * from hheadlineads where userid='".$userid."'";
	    $result3 = mysql_query ($query3) or die(mysql_error());
	    $numrows3 = @ mysql_num_rows($result3);
	    if ($numrows3 == 0) {
	        ?>
...
############################################################################## HOT HEADER AD STATS - Sabrina Markon July 11 2010
	    $query3 = "select * from hheaderads where userid='".$userid."'";
	    $result3 = mysql_query ($query3) or die(mysql_error());
	    $numrows3 = @ mysql_num_rows($result3);
	    if ($numrows3 == 0) {
	        ?>
...
############################################################################## END HOT HEADER AD STATS - Sabrina Markon June 11 2010
       ...
       $query = "SELECT * FROM banners where userid='".$userid."'";
	    $result = mysql_query ($query)
	            or die ("Query failed");
 ...
 <?
    ...
    $query = "SELECT * FROM buttons where userid='".$userid."'";
	    ...
	    $query2 = "SELECT * FROM solos where userid='".$userid."'";
...
<?
		...
		$traffictoadd = 0;
		$trafficcount = 0;
		$query2 = "SELECT * FROM hotlinks where userid='".$userid."'";
	    ...
	    if ($trafficstatstoshow == 1) {
	        ...
	        ?><br>
	          ...
	          $result3 = mysql_query ("SELECT * FROM hotlinks where added !=0 and userid='".$userid."'")
...
<?
      ...
      // ---------------------------------------------------------------
	    $query3 = "SELECT * FROM tlinks where userid='".$userid."'";
   ...
   $query3 = "SELECT * FROM ptcads where userid='".$userid."'";
	    $result3 = mysql_query ($query3)
	            or die ("Query failed");
	    $numrows3 = @ mysql_num_rows($result3);
	    if ($numrows3 == 0) {
	    ...
	    if ($ptclinkstatstoshow == 1) {
		    ...
		    $query = "SELECT * FROM topnav where userid='".$userid."'";
	    $result = mysql_query ($query)
	            or die ("Query failed");
	    $numrows = @ mysql_num_rows($result);
	    if ($numrows == 0) {
 ...
 <?
      ...
      $query = "SELECT * FROM botnav where userid='".$userid."'";
	    $result = mysql_query ($query)
	            or die ("Query failed");
	    $numrows = @ mysql_num_rows($result);
	    if ($numrows == 0) {
 ...
 <?
		...
		$query3 = "SELECT * FROM loginads where userid='".$userid."'";
	    $result3 = mysql_query ($query3)
	            or die ("Query failed");
	    $numrows3 = @ mysql_num_rows($result3);
	    if ($numrows3 == 0) {
...
$query3 = "SELECT * FROM footerads where userid='".$userid."'";
	    $result3 = mysql_query ($query3)
	            or die ("Query 4 failed");
	    $numrows3 = @ mysql_num_rows($result3);
	    if ($numrows3 == 0) {
