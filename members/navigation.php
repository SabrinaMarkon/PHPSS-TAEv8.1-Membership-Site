...
if($_POST['resend']) {
	...
	$message = "Hello,\n\n"
		   ...
		   ."".$adminemail."\n\n\n\n";
				...
				@mail($contact_email, $subject, $message, $headers, "-f $return_path");
...
<table align=center width="1160" bgcolor=#F4D223><tr><td><center>
...
<table align="center" width="1160" cellpadding=2 cellspacing=0 bgcolor="#FFFFFF" border=1>
...
<td width=580 bgcolor="<?php echo $hheaderadtopnotebgcolor ?>" align="center"><b><font style="color: <?php echo $hheaderadtopnotefontcolor ?>; font-family: <?php echo $hheaderadtopnotefontface ?>; size: <?php echo $hheaderadtopnotefontsize ?>;">HOT Headline Adz! - Click To The Right for <b><?php echo $hheadlineadearn ?> points --></b></td>
...
<td width=580 bgcolor="<?php echo $hheaderbgcolor ?>" align="center"><a target="_blank" href="./hheaderadclicks.php?id=<?php echo $hheaderid ?>" target=\"_blank\">

<img src="<?php echo $hheaderbanner ?>" border="0" height="60" width="568"></a></td>

<td bgcolor="<?php echo $hheaderbgcolor ?>"><div style="width: 580px; padding: 2px; overflow:auto; background: <?php echo $hheaderbgcolor ?>; color: <?php echo $hheaderheadingfontcolor ?>;"><b><a style="color:<?php echo $hheaderheadingfontcolor ?>" target="_blank" href="./hheaderadclicks.php?id=<?php echo $hheaderid ?>"><?php echo $hheaderheading ?></a></b></div><div style="width: 580px; height: 60px; padding: 2px; overflow:auto; background: <?php echo $hheaderbgcolor ?>; color: <?php echo $hheaderdescriptionfontcolor ?>;"><?php echo $hheaderdescription ?></div></td>
...
//update the banners displayed
    ...
    $upnavresult = mysql_query ($upnavquery);
	        ...
	        <BR><table border=1 cellpadding=0 cellspacing=0 width=165 height=26><tr valign=middle><td align="center" nowrap style="background: url(<?php echo $domain ?>/images/menu1.png)" onMouseDown="this.style.backgroundImage='url(<?php echo $domain ?>/images/menu2.png)'" onMouseOver="this.style.backgroundImage='url(<?php echo $domain ?>/images/menu2.png)'" onMouseOut="this.style.backgroundImage='url(<?php echo $domain ?>/images/menu1.png)'"><a href="<? echo "topnavclicks.php?id=".$navid; ?>" target="_blank" class="button" onmouseover="window.status='<? echo $navname; ?>';return true" onMouseOut="window.status='';return true" target="_blank" style="color: #fff; font-weight: bold;"><? echo $navname; ?></a></td></tr></table>
    ...
    while ($navline = mysql_fetch_array($navresult)) {
		...
		$navname = $navline["name"];
	       ...
	       if ($navline["memtype"]==$memtype OR $navline["memtype"]==""){
	        ...
	        <center><table border=1 cellpadding=0 cellspacing=0 width=165 height=30><tr valign=middle><td align="center" nowrap style="background: url(<?php echo $domain ?>/images/menu1.png)" onMouseDown="this.style.backgroundImage='url(<?php echo $domain ?>/images/menu2.png'" onMouseOver="this.style.backgroundImage='url(<?php echo $domain ?>/images/menu2.png)'" onMouseOut="this.style.backgroundImage='url(<?php echo $domain ?>/images/menu1.png)'"><a href="<? echo $navurl; ?>" class="button" target="_blank" onmouseover="window.status='<? echo $navname; ?>';return true" onMouseOut="window.status='';return true" style="color: #fff; font-weight: bold;">&nbsp;&nbsp;&nbsp;<? echo $navname; ?>&nbsp;&nbsp;&nbsp;</a></td></tr></table>
	        ...
	        <center><table border=0 cellpadding=0 cellspacing=0 width=165 height=30><tr valign=middle><td align="center" wrap style="background: url(<?php echo $domain ?>/images/menu1.png)" onMouseDown="this.style.backgroundImage='url(<?php echo $domain ?>/images/menu2.png)'" onMouseOver="this.style.backgroundImage='url(<?php echo $domain ?>/images/menu2.png)'" onMouseOut="this.style.backgroundImage='url(<?php echo $domain ?>/images/menu1.png)'"><a href="<? echo $navurl; ?>" class="button" onmouseover="window.status='<? echo $navname; ?>';return true" onMouseOut="window.status='';return true" style="color: #fff; font-weight: bold;">&nbsp;&nbsp;&nbsp;<? echo $navname; ?>&nbsp;&nbsp;&nbsp;</a></td></tr></table>
...
//update the banners displayed
    ...
    $upnavresult = mysql_query ($upnavquery);
	        ...
	        <BR><table border=1 cellpadding=0 cellspacing=0 width=165 height=26><tr valign=middle><td align="center" nowrap style="background: url(<?php echo $domain ?>/images/menu1.png)" onMouseDown="this.style.backgroundImage='url(<?php echo $domain ?>/images/menu2.png)'" onMouseOver="this.style.backgroundImage='url(<?php echo $domain ?>/images/menu2.png)'" onMouseOut="this.style.backgroundImage='url(<?php echo $domain ?>/images/menu1.png)'"><a href="<? echo "botnavclicks.php?id=".$navid; ?>" target="_blank" class="button" onmouseover="window.status='<? echo $navname; ?>';return true" onMouseOut="window.status='';return true" target="_blank" style="color: #fff; font-weight: bold;"><? echo $navname; ?></a></td></tr></table>
