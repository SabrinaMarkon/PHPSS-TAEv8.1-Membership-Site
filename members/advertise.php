...
<p><b>Purchase Special Offer Ad Package</p></b>
		  ...
		  <?php
			...
			<input type="hidden" name="item_number" value="<? echo $sitename; ?> Special Offer Ad Package ">
			...
			<input type="hidden" name="currency_code" value="USD">
			<input type="image" src="https://www.paypal.com/en_US/i/btn/x-click-but6.gif" border="0" name="submit" alt="Make payments with PayPal - it's fast, free and secure!">
			<input type="hidden" name="a3" value="<? echo $offer['price']; ?>">
			<input type="hidden" name="return" value="<? echo $domain; ?>/members/paidreturn.php">
			<input type="hidden" name="cancel_return" value="<? echo $domain; ?>/">
			...
			<input type="hidden" name="ap_itemcode" value="<? echo $sitename; ?> Special Offer Ad Package "/> 
			<input type="hidden" name="ap_quantity" value="1"/> 
