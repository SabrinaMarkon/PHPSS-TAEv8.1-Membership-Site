...
include "config.php";
	...
	if ($adminmoneybookers == $_REQUEST['pay_to_email'] AND $moneybookers_id == $_REQUEST['merchant_id'] AND $_REQUEST['status'] == 2){
		...
		if ($numrows == 1) {
			...
			$paychoice = "Moneybookers";
			$transaction = "Moneybookers";
...
#buycommission($referid, $amount);
			...
			if ($refrows > 0) {
				...
				if ($refmemtype == "PRO") {
					...
					$refearn = $amount*$percent/100;
					mysql_query("update members set commission=commission+".$refearn." where userid='".$referid."'");
					mysql_query("insert into transactions values ('id', '".$referid."','Buyer Commissions','".time()."','$refearn')");
			...
			$refmessage = "A member of your downline, " . $userid . ", just purchased " . $item . " for " . $amount . "\n"
...
mysql_query("INSERT INTO transactions VALUES ('id','".$userid."','Skrill payment - AdPack ID#$adpackid','".time()."','$amount\$')");	
}

			if($item == $sitename." One-Time Offer") {

				mysql_query("INSERT INTO transactions VALUES ('id', '".$userid."','Moneybookers payment - OTO','".time()."','$amount\$')");
			...
			elseif($item == $sitename." Points ".$userid) {
				...
				mysql_query("INSERT INTO transactions VALUES ('id', '".$userid."','Moneybookers payment - 1000 points','".time()."','$amount\$')");
			...
			elseif($item == $sitename." Solo Ad ".$userid) {
				mysql_query("INSERT INTO transactions VALUES ('id', '".$userid."','Moneybookers payment - Solo Ad','".time()."','$amount\$')");
				...
				mysql_query("INSERT INTO transactions VALUES ('id', '".$userid."','Moneybookers payment - Banner Impressions','".time()."','$amount\$')");
	...
	mysql_query("INSERT INTO transactions VALUES ('id', '".$userid."','Moneybookerspayment - Button Banner Ad','".time()."','$amount\$')");
				...
				mysql_query("INSERT INTO transactions VALUES ('id', '".$userid."','Moneybookers payment - ".$quantity." solo footer ad','".time()."','$payment_amount\$')");
		...
		mysql_query("INSERT INTO transactions VALUES ('id','".$userid."','Moneybookers payment - Daily Bonus $rented','".time()."','$amount\$')");	
				...
				mysql_query("INSERT INTO transactions VALUES ('id','".$userid."','Moneybookers payment - Full Page Login Ad $rented','".time()."','$amount\$')");	
				...
				mysql_query("INSERT INTO transactions VALUES ('id','".$userid."','Moneybookers payment - Featured Ad $featuredadmaxhits Impressions','".time()."','$amount\$')");	
				

			} elseif($item == $sitename." Hot Headline Ad ".$userid) {
				$hheadlineadmaxhits = $_POST['max'];
				mysql_query("INSERT INTO transactions VALUES ('id','".$userid."','Moneybookers payment - Hot Headline Ad $hheadlineadmaxhits Impressions','".time()."','$amount\$')");	
				while($quantity > 0) {
				...
				mysql_query("INSERT INTO transactions VALUES ('id','".$userid."','Moneybookers payment - Hot Header Ad $hheaderadmaxhits Clicks','".time()."','$amount\$')");
				while($quantity > 0) {
				...
				mysql_query("INSERT INTO transactions VALUES ('id', '".$userid."','Moneybookers payment - Top Navigation link','".time()."','$amount\$')");
				...
				mysql_query("INSERT INTO transactions VALUES ('id', '".$userid."','Moneybookers payment - Bottom Navigation link','".time()."','$amount\$')");
				...
				mysql_query("INSERT INTO transactions VALUES ('id', '".$userid."','Moneybookers payment - Login ad','".time()."','$amount\$')");
				
					mysql_query("insert into loginads (userid,max) values('$userid','1000')");


			} elseif($item == $sitename." Traffic link 50 ".$userid) {
				mysql_query("INSERT INTO transactions VALUES ('id', '".$userid."','Moneybookers payment - Traffic link 50','".time()."','$amount\$')");
				...
				mysql_query("INSERT INTO transactions VALUES ('id', '".$userid."','Moneybookers payment - Traffic link 100','".time()."','$amount\$')");
				...
				mysql_query("INSERT INTO transactions VALUES ('id', '".$userid."','Moneybookers payment -  Traffic link 200','".time()."','$amount\$')");
				...
				mysql_query("INSERT INTO transactions VALUES ('id', '".$userid."','Moneybookers payment - PTC 50','".time()."','$amount\$')");
				...
				mysql_query("INSERT INTO transactions VALUES ('id', '".$userid."','Moneybookers payment - PTC 100','".time()."','$amount\$')");
				...
				mysql_query("INSERT INTO transactions VALUES ('id', '".$userid."','Moneybookers payment -  PTC 200','".time()."','$amount\$')");
				...
				mysql_query("INSERT INTO transactions VALUES ('id','".$userid."','Moneybookers payment - Hot Link','".time()."','$amount\$')");
				
					mysql_query("insert into hotlinks (userid,max) values('$userid','5000')");		
					
			} elseif($item == $sitename." Hot Link Pack 2 ".$userid) {
				mysql_query("INSERT INTO transactions VALUES ('id','".$userid."','Moneybookers payment - Hot Link 2','".time()."','$amount\$')");
				
					mysql_query("insert into hotlinks (userid,max) values('$userid','10000')");	

			} elseif($item == $sitename." Hot Link Pack 3 ".$userid) {
				mysql_query("INSERT INTO transactions VALUES ('id','".$userid."','Moneybookers payment - Hot Link 3','".time()."','$amount\$')");
				...
				mysql_query("INSERT INTO transactions VALUES ('id', '".$userid."','Moneybookers payment - " . $middlelevel . " Member Upgrade','".time()."','$amount\$')");
				upgrade_jv($userid,"yes",$referid);
			} elseif($item == $sitename." " . $toplevel . " Membership ".$userid) {

				mysql_query("INSERT INTO transactions VALUES ('id', '".$userid."','Moneybookers payment - " . $toplevel . " Upgrade','".time()."','$amount\$')");
				upgrade_superjv($userid,"yes",$referid);
			} elseif($item == $sitename." Special Offer") {

				mysql_query("INSERT INTO transactions VALUES ('id', '".$userid."','Moneybookers payment - Special Offer','".time()."','$amount\$')");
