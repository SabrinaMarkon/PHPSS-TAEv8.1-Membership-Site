...
{
echo "<p>".$superjvcommission."% commission for every ".$lowerlevel." member referred</p>";
}
if ($superjvjvcom<>0)
{
echo "<p>".$superjvjvcom."% commission for every ".$middlelevel." Member referred</p>";
}
if ($superjv2supercom<>0)
{
echo "<p>".$superjv2supercom."% commission for every ".$toplevel." Member referred</p>";
}
?>
...
if ($jvcommission<>0)
{
echo "<p>".$jvcommission."% commission for every ".$lowerlevel." member referred</p>";
}
if ($jvjvcom<>0)
{
echo "<p>".$jvjvcom."% commission for every ".$middlelevel." Member referred</p>";
}
if ($jvsupercom<>0)
{
echo "<p>".$jvsupercom."% commission for every ".$toplevel." Member referred</p>";
}
?>
...
if ($procommission<>0)
{
echo "<p>".$procommission."% commission for every ".$lowerlevel." member referred</p>";
}
if ($projvcom<>0)
{
echo "<p>".$projvcom."% commission for every ".$middlelevel." Member referred</p>";
}
if ($prosupercom<>0)
{
echo "<p>".$prosupercom."% commission for every ".$toplevel." Member referred</p>";
}
?>        
<p>Price: <b>FREE</b></p>
...
<input type="text" size="25" value name="new_userid">
