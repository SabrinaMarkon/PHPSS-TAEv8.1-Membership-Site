...
for($k=1;$k<=$apquantity;$k++)
{
	...
	$price = mysql_result($apackr,0,"price");
...
<tr bgcolor="#eeeeee"><td>Price:</td><td><input type="text" name="price" value="<? echo $offer["price"]; ?>"></td></tr>
...
<tr><td colspan="2" align="center">
<table cellpadding="0" cellspacing="2" border="0" align="center" width="90%" bgcolor="#999999">
<tr><td align="center" colspan="6"><div class="heading"><?php echo $sitename ?> AdPacks</div></td></tr>
<tr bgcolor="#eeeeee"><td align="center"><b>Description</b></td><td align="center"><b>Price</b></td><td align="center"><b>Enabled</b></td><td align="center"><b>How Many Times Chosen</b></td><td align="center"><b>Edit</b></td><td align="center"><b>Delete</b></td></tr>
<?php
...
<a href="javascript:;" onclick="document.getElementById('showadpack').innerHTML='<?php echo $details ?>';"><?php echo $description ?></a></td><td align="center"><?php echo $price ?></td><td align="center"><?php echo $enabled ?></td><td align="center"><?php echo $howmanytimeschosen ?></td>
<form method="POST" action="adpacks_admin.php">
<td align="center">
...
?>
<tr bgcolor="#eeeeee"><td colspan="6" align="center">
...
<tr bgcolor="#eeeeee"><td colspan="2">If you create AdPacks below, your members will be able to buy them from the members area for purchasing advertising.</td></tr>
<form method="POST" action="adpacks_admin.php">
...
<tr bgcolor="#eeeeee"><td>Price:</td><td><input type="text" name="price" value="0.00"></td></tr>
