...
<table align=center><tr><td><?=$pagination?></td></tr></table>
 ...
 while ($line = mysql_fetch_array($result)) {		$name = $line["name"];
        ...
        ?>
          ...
          <td bgcolor="<? echo $basecolour; ?>"><font size=2 face="<? echo $fonttype; ?>" color="<? echo $fontcolour; ?>"><center><a target="_blank" href="memberlogin.php?userid=<? echo $userid; ?>"><? echo $userid; ?></font></center></td>
