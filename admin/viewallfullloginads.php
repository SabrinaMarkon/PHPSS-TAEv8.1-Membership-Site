...
echo "<center><font color=\"#ff0000\">" . $message . "</font></center><br>";
		...
		<form method="POST" action="viewallfullloginads.php">
          <td bgcolor="<? echo $basecolour; ?>"><center><font size=2 face="<? echo $fonttype; ?>" color="<? echo $fontcolour; ?>"><a target="_blank" href="memberlogin.php?userid=<? echo $userid; ?>"><? echo $userid; ?></a></font></center></td>
