...
$update=mysql_query("update settings set setting='$smtp_hostp' where name='smtp_host'");
$update=mysql_query("update settings set setting='$smtp_portp' where name='smtp_port'");
$update=mysql_query("update settings set setting='$smtp_usernamep' where name='smtp_username'");
$update=mysql_query("update settings set setting='$smtp_passwordp' where name='smtp_password'");
$update=mysql_query("update settings set setting='$mailermethodp' where name='mailermethod'");
...
<br><br>
       ...
       <input type="password" name="adminpwp" value="<?php echo $adminpw ?>"><br><br>
       ...
       Mailer Method<br>
       <select name="mailermethodp"><option value="smtp" <?php if ($mailermethod == "smtp") { echo "selected"; } ?>>SMTP</option><option value="phpmail" <?php if ($mailermethod != "smtp") { echo "selected"; } ?>>PHP Mail()</option></select><br><br>
       Your SMTP Host Name (ie. mail.yourdomain.com)<br>
       <input type="text" name="smtp_hostp" value="<? echo $smtp_host; ?>"><br><br>
       Your SMTP Port<br>
       <input type="text" name="smtp_portp" value="<? echo $smtp_port; ?>"><br><br>
       Your SMTP Email Username (ie. youremail@yourdomain.com)<br>
       <input type="text" name="smtp_usernamep" value="<? echo $smtp_username; ?>"><br><br>
       Your SMTP Email Password<br>
       <input type="text" name="smtp_passwordp" value="<? echo $smtp_password; ?>"><br><br>
